...
import { CircleQuestionMark, TrendingUp, Workflow, Users, Sparkles } from 'lucide-react';
...
export default function Landing() {
  ...
  return (
    <div style={{
      ...
      <CircleQuestionMark  size={130} className='ms-auto h-auto w-auto reveal '/>
      <div className="d-flex rounded border border-primary ps-2 pe-2 m-3 w-75 justify-content-start align-items-start bg-dark bg-opacity-75 reveal">
        <h2 className='text-2xl font-bold text-primary' style={{display:'flex',alignItems:'center',gap:8}}>What is a Near-Miss?</h2>
        <ul>
        <li>
      ...
      <div className="d-flex rounded border border-primary ps-2 pe-2 m-3 w-75 justify-content-start align-items-start bg-dark bg-opacity-75 reveal">
        <h2 className='text-2xl font-bold text-primary' style={{display:'flex',alignItems:'center',gap:8}}>Why It Matters</h2>
        <ul>
        <li>
      ...
      </div><TrendingUp size={140} className='me-auto h-auto w-auto reveal'/></div>
      <div className='d-flex'>
      <Workflow size={140} className='ms-auto h-auto w-auto reveal'/>
      <div className=" d-flex rounded border border-primary ps-2 pe-2 m-3 w-75 justify-content-start align-items-start bg-dark bg-opacity-75 reveal">
        <h2 className='text-2xl font-bold text-primary' style={{display:'flex',alignItems:'center',gap:8}}>How does it works  </h2>
        <ul>
      ...
      <div className="d-flex rounded border border-primary ps-2 pe-2 m-3 w-75 justify-content-start align-items-start bg-dark bg-opacity-75 reveal">
        <h2 className='text-2xl font-bold text-primary' style={{display:'flex',alignItems:'center',gap:8}}>Benefits & Use Cases</h2>
        <ul>
      ...
      </div><Users size={140} className='me-auto h-auto w-auto reveal'/></div>
      <div className='d-flex'>
      <Sparkles size={140} className='ms-auto h-auto w-auto reveal'/>
      <div className="d-flex rounded border border-primary ps-2 pe-2 m-3 w-75 justify-content-start align-items-start bg-dark bg-opacity-75 reveal">
        <h2 className='text-2xl font-bold text-primary' style={{display:'flex',alignItems:'center',gap:8}}>Future Enhancement</h2>
        <ul>
